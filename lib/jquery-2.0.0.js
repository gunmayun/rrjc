 ...
 *
 * Includes Sizzle.js 复杂选择器文件名称
 * http://sizzlejs.com/  复杂选择器文件网站
 *
 * Copyright 2005, 2013 jQuery Foundation, Inc. and other contributors  版权信息
 * Released under the MIT license 开源协议
 * http://jquery.org/license
 *
 * Date: 2013-04-18 更新时间
 */
(function( window, undefined ) {
/*
#13335
1.问题说明可以根据这个到jQuery官方网站的https://bugs.jquery.com/中查看更详细的说明和其它开发者的讨论信息
2.后续版本的说明已经更新到github

 "use strict"; 严格模式
要求必须严格按照JS语法编写代码, 否则浏览器会报错
例如在非严格模式下定义变量可以不加var也不会报错, 但是在严格模式下如果不加var会报错
 */
	var
		/*
		 定义变量保存通过jQuery(document)找到的document对象
		 1.为了方便代码压缩
		 2.为了提高阅读性
		 var result = 'zs' + '18';
		 var name = 'zs';
		...
		readyList,
		/*
		兼容处理, 在IE6789下xml中直接判断一个变量是不是等于undefined 在ie9及以下版本中会判断不到，需用typeof判断。所以存储了字符串形式的 “undefined"
		 */
		...
		// 这两个变量是为了防止冲突, 会在防冲突函数 noConflict 中使用
		...
		// 用于防止 XSS location.hash木马注入的正则表达式
		// <div>lnj  #nj
		rquickExpr = /^(?:(<[\w\W]+>)[^>]*|#([\w-]*))$/,
